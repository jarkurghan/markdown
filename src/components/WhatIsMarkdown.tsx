...
const WhatIsMarkdown: React.FC<WhatIsMarkdownProps> = ({ isDark, isFullscreen }) => {
  const examples = [
    {
      title: 'Headers',
      icon: Hash,
    ...
    },
    {
      title: 'Tables & Data',
      icon: Table,
      markdown: '| Feature | Markdown | HTML |\n|---------|----------|------|\n| Simple | ✅ | ❌ |\n| Readable | ✅ | ❌ |\n| Powerful | ✅ | ✅ |\n\n| Left | Center | Right |\n|:-----|:------:|------:|\n| L1 | C1 | R1 |\n| L2 | C2 | R2 |',
      ...
      <article className={`max-w-4xl mx-auto p-8 ${
        ...
        <header className="text-center mb-16">
          ...
          <p className={`text-xl leading-relaxed max-w-3xl mx-auto ${
            ...
            Discover the lightweight markup language that revolutionized how we write and format text. 
            Learn why millions of developers, writers, and content creators choose Markdown for their daily work.
          </p>
        </header>
        ...
        <section className="mb-16">
          <div className={`p-8 rounded-2xl border ${
            ...
            <div className={`prose prose-lg max-w-none ${
              ...
              <p className="mb-4">
                Markdown was created in 2004 by <strong>John Gruber</strong> in collaboration with Aaron Swartz. 
                The goal was simple yet revolutionary: create a way to write using an easy-to-read, 
                easy-to-write plain text format that could be converted to structurally valid HTML.
              </p>
              <p className="mb-4">
                The name "Markdown" is a play on the word "markup," referencing how it allows you to 
                mark up text with formatting in a way that remains readable even in its raw form. 
                Unlike HTML or other markup languages, Markdown prioritizes human readability.
              </p>
              <p>
                Today, Markdown has become the de facto standard for documentation, README files, 
                forum discussions, and content creation across the web. From GitHub to Reddit, 
                from technical documentation to personal blogs, Markdown powers text formatting everywhere.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {useCases.map((useCase, index) => (
              <div key={index} className={`p-8 rounded-xl border ${
                isDark 
                  ? 'bg-gray-800/50 border-gray-700' 
                  : 'bg-white border-gray-200'
              } hover:shadow-lg transition-all duration-300`}>
        ...
        <section className={`p-8 rounded-2xl border ${
          ...
          <h2 className={`text-3xl font-bold mb-6 ${
            ...
            Ready to Start Your Markdown Journey?
          </h2>
          <p className={`text-lg mb-8 max-w-2xl mx-auto ${
            isDark ? 'text-gray-300' : 'text-gray-600'
          }`}>
            Now that you understand the power and simplicity of Markdown, it's time to put it into practice. 
            Head back to our editor and start creating your first Markdown document with confidence!
          </p>
